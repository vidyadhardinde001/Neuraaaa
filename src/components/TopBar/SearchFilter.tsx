 ...
 * -----------------------
 * Provides filtering options for search:
 *  - Specify file extension (e.g., "txt", "pdf").
 *  - Toggle inclusion of files and/or directories.
 * Ensures at least one of "files" or "directories" is always selected.
 *
 * Communicates with:
 *  - SearchBar.tsx (parent component that executes searches with these filters).
 *  - ../../ui/Input.tsx (custom styled input for extension field).
 */
