...
import { createFile, createDirectory, deleteFile, renameFile, RenamerResult } from "../../ipc";
        ...
        <>
            {currentContextMenu === ContextMenuType.General ? (
                <ContextMenu options={[
                    ...
                    { name: duplicateDeleteLoading ? "Scanning..." : "Find Duplicates", onClick: onFindDuplicates, disabled: duplicateDeleteLoading },
                ]} />
